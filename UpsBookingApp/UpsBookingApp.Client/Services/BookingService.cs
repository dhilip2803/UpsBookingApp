...
{
    new Desk { Id = 1, Name = "Desk A1", Location = "Near Window", Description = "Near to Cafeteria", Floor = "Floor 1", IsAvailable = true },
    new Desk { Id = 2, Name = "Desk B2", Location = "Corner Spot", Description = "Beside ATS seatings", Floor = "Floor 1", IsAvailable = true },
    new Desk { Id = 3, Name = "Desk C3", Location = "Next to Pantry", Description = "Campus 30 beside pantry 1", Floor = "Floor 2", IsAvailable = true },
    new Desk { Id = 4, Name = "Desk D4", Location = "Quiet Zone", Description = "Near to game room", Floor = "Floor 2", IsAvailable = true }
};
